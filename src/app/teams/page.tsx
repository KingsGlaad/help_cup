    ...
    <div className="min-h-screen bg-background font-sans antialiased text-foreground flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-6xl">
        <div className="mb-10 text-center sm:text-left">
          <h1 className="text-4xl font-extrabold tracking-tight mb-3">Seleções</h1>
          <p className="text-lg text-muted-foreground">Conheça todas as seleções participantes da Copa do Mundo 2026.</p>
        </div>

        {loadingTeams ? (
          <div className="flex flex-col items-center justify-center min-h-[40vh]">
            <div className="w-12 h-12 border-4 border-primary border-t-transparent rounded-full animate-spin mb-4"></div>
            <p className="text-muted-foreground animate-pulse font-medium">Carregando seleções...</p>
          </div>
        ) : (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {teams.map((team) => (
              ...
              >
                ...
                <h3 className="font-bold text-base leading-tight mb-1">{team.team_name}</h3>
